 ...
 * @author CR2 SISTEMAS
 */
public class ListarFuncionarioInativoController extends AbstractController {
    ...
    public void execute() {
        ...
        try {
            ...
            funcionarios = (List) dao.listarTodasInativos();
            this.getRequest().setAttribute("lista_funcionarios", funcionarios);
            this.setReturnPage("/paginas/views/funcionariosInativos.jsp");
