 ...
 * @author CR2 SISTEMAS
 */
public class BuscaFuncionarioController extends AbstractController {
    ...
    public void execute() {
        ...
        try {
            ...
            funcionarios = (List) dao.buscaPeloNome(this.getRequest().getParameter("nomeBusca"));
            this.getRequest().setAttribute("lista_funcionarios", funcionarios);
            this.setReturnPage("/paginas/views/buscaFuncionario.jsp");
