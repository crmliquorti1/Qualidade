                        ...
                        <div class="tab-content">
                            ...
                            <script>
                                function myFunction() {
                                    ...
                                    if (x == 'internado') {
                                        document.getElementById('internadoProc').style.display = 'block';
                                        document.getElementById('prontoSocorro').style.display = 'none';
                                    } else if (x == 'pronto socorro') {
                                        document.getElementById('prontoSocorro').style.display = 'block';
                                        document.getElementById('internadoProc').style.display = 'none';
                                    } else {
                                        document.getElementById('internadoProc').style.display = 'none';
                                        document.getElementById('prontoSocorro').style.display = 'none';
                                    }
                            ...
                            <div class="tab-pane" id="four">
                                ...
                                <div class="linha">
                                    ...
                                    <div id="prontoSocorro" style="display:none">
                                        <div class="table-responsive">
                                            <center>
                                    ...
                                    <div id="internadoProc" style="display:none">
                                        <div class="table-responsive">
                                            <center>
                                                <table class="table-exames table-striped" width="50%" border="1">
                                                    ...
                                                    <tr><td class="tab-lis"> <input type="checkbox" name="exame" value="bar23"/></td>
                                                    <td class="tab-lis"> 40309070 </td>
                                                    <td class="tab-lis"> LXSP </td>
                                                    <td class="tab-lis"> LATEX-STREPTOCOCCUS PNEUMONIAE </td>
                                                    </tr>

                                                    <tr><td class="tab-lis"> <input type="checkbox" name="exame" value="bar24"/></td>
                                                    <td class="tab-lis"> 40309070 </td>
                                                    <td class="tab-lis"> LXST </td>
                                                    <td class="tab-lis"> LATEX-STREPTOCOCCUS TIPO B </td>
                                                    </tr>
